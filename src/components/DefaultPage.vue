<template>
  <div class="default-page">
    ...
    <div class="content" v-if="!formStatus">
      <h1>ОФОРМИ ЛЮБОЙ КРЕДИТ В МИНСКЕ ПО СТАВКЕ ОТ 13,99%!</h1>
      <h3>ОСТАВЬ НОМЕР ТЕЛЕФОНА И ПОЛУЧИ ЧЕРЕЗ НАС КРЕДИТ ПО СНИЖЕННОЙ СТАВКЕ</h3>
      <div class="form">
<!--        <div>-->
...
.default-page{
  ...
  padding: 0;
  margin: 0;
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.65)), url('https://s1.1zoom.ru/b2948/884/Money_Banknotes_Dollars_100_565560_1600x1200.jpg');
